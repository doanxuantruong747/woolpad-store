...
const SelectLanguage = () => {
  ...
  const langLoading = localStorage.getItem('i18nextLng');
      ...
      <div className=" flex justify-end items-center font-medium relative">
        ...
        >
            ...
            <div className="flex items-center m-0 ">
              <div className="w-fit md:w-[50px] m-0 md:mr-2 flex justify-center">
                <div className="relative w-[30px] h-[30px]">
                  <Image fill src={flaguk} alt="flag en" layout="fill" objectFit="contain" />
                </div>
              </div>
              <span className="hidden xl:block text-[16px] text-white">English</span>
            </div>
          )}
          {langLoading === 'vi' && (
            <div className="flex items-center m-0 ">
              <div className="w-fit md:w-[50px] m-0 md:mr-2 flex justify-center">
                <div className="relative w-[30px] h-[30px]">
                  <Image fill src={flagvn} alt="flag en" layout="fill" objectFit="contain" />
                </div>
              </div>
              <span className="hidden md:block text-[16px] text-white">Vietnamese</span>
            </div>
          )}
          ...
          {langLoading === 'korean' && (
            <div className="flex items-center m-0 ">
              <div className="w-fit md:w-[50px] m-0 md:mr-2 flex justify-center">
                <div className="relative w-[30px] h-[30px]">
                  <Image fill src={flagkr} alt="flag en" layout="fill" objectFit="contain" />
                </div>
              </div>
              <span className="hidden md:block text-[16px] text-white">Korean</span>
            </div>
          )}
        </div>
        <div
          className={`${isOpenLanguage
        ...
        >
          <ul className="py-1 text-sm text-gray-700 dark:text-gray-200">
            <li
              className="py-1 px-4 mb-1 cursor-pointer"
              onClick={() => {
